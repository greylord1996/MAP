...
this framework. You don't need to import other modules.

The typical baseline structures as follows:
you collect data in time domain, transform it to frequency domain
by employing 'prepare_data' function and obtain posterior parameters
...
def perturb_params(true_params, dev_fractions):
    ...
    Args:
        true_params (numpy.ndarray): True parameters of a dynamical system.
...
def prepare_data(time_data, snr=None, remove_zero_freq=True,
    ...
    Args:
        ...
        snr (double, optional): The value of SNR specifying noise
            ...
            Defaults to None which corresponds to absence of any noise.
        ...
        max_freq (double, optional): The right border of analyzing data
            ...
            all frequencies will be analyzed.
...
def compute_posterior_params(freq_data, admittance_matrix,
    ...
    """Calculate posterior parameters based on Bayesian approach.
